...
builder.Services.AddDbContext<CW_PD8.Models.AccountContext>(opt => opt.UseSqlServer("Data Source=db-mssql16.pjwstk.edu.pl;Initial Catalog=s17943;Integrated Security=True;Encrypt=True;TrustServerCertificate=True"));
